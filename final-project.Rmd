...
#### Question 4)
Here we demonstrate that the duration of film doesn't influence the average of users rating. There is no relation between this 2 factors.
...
#### Question 8)
Here we can see that the release year does not influence in the popularity and revenue of a movie.
